...
function generatePrismaSvg(prismaData: any): string {
  // Simple PRISMA flow SVG generation
  const { identified, duplicates, screened, included, excluded } = prismaData;

  return `<svg width="600" height="400" xmlns="http://www.w3.org/2000/svg">
    <rect width="600" height="400" fill="white"/>
    <text x="300" y="30" text-anchor="middle" font-size="16" font-weight="bold">PRISMA Flow Diagram</text>

    <rect x="250" y="50" width="100" height="40" fill="#e3f2fd" stroke="#1976d2"/>
    <text x="300" y="75" text-anchor="middle" font-size="12">Identified: ${identified}</text>

    <rect x="250" y="120" width="100" height="40" fill="#fff3e0" stroke="#f57c00"/>
    <text x="300" y="145" text-anchor="middle" font-size="12">Duplicates: ${duplicates}</text>

    <rect x="250" y="190" width="100" height="40" fill="#f3e5f5" stroke="#7b1fa2"/>
    <text x="300" y="215" text-anchor="middle" font-size="12">Screened: ${screened}</text>

    <rect x="150" y="260" width="100" height="40" fill="#e8f5e8" stroke="#388e3c"/>
    <text x="200" y="285" text-anchor="middle" font-size="12">Included: ${included}</text>

    <rect x="350" y="260" width="100" height="40" fill="#ffebee" stroke="#d32f2f"/>
    <text x="400" y="285" text-anchor="middle" font-size="12">Excluded: ${excluded}</text>

    <!-- Arrows -->
    <path d="M 300 90 L 300 120" stroke="black" stroke-width="2" marker-end="url(#arrowhead)"/>
    <path d="M 300 160 L 300 190" stroke="black" stroke-width="2" marker-end="url(#arrowhead)"/>
    <path d="M 280 230 L 220 260" stroke="black" stroke-width="2" marker-end="url(#arrowhead)"/>
    <path d="M 320 230 L 380 260" stroke="black" stroke-width="2" marker-end="url(#arrowhead)"/>
